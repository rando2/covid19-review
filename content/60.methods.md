...
The contents of the COVID-19 Open Research Dataset (CORD-19), which was developed in part to assist in efforts to train machine learning algorithms on COVID-19-related text, illustrates the volume of publication relevant to understanding this virus (Figure X).
A resource focusing specifically on SARS-CoV-2, SARS-CoV-1, and MERS-CoV, CoronaCentral [@doi:10.1101/2020.12.21.423860], has curated CORD-19 and other resources into a set of over 150,000 publications particularly relevant to COVID-19.

<!--To Do: Insert CORD-19 data viz here-->
