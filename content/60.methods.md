...
As of April 30, 2021, there are 49 authors, 1,428 references, and 131,949 words in the documents that make up the project.
...
The manuscript has continued to grow throughout the first year of the project, with both word count and number of references continuing to trend upwards (Figure @fig:projectstats).
...
As of April 30, 2021, there are 1,428 references (Figure @fig:projectstats).
The scite plugin provided a way to visually inspect the reference list to identify possible references of concern. <!--I changed this to past tense, since it's discussed earlier.-->
This and the other new features required for the COVID-19 project are now included in Manubot's rootstock.
...
Using CI, Manubot now checks that the manuscript was built correctly, runs a spell-checker, and cross-references the manuscripts cited in this review.<!-- we probably can't include the appendix? original sentence ended with: as summarized in Appendix A and discussed in the project's issues and pull requests.-->
