...
As of April 30, 2020, there are 49 authors, 1,428 references, and 131,949 words in the documents that make up the project.
...
As of April 30, 2020, there are 1,428 references (Figure @fig:projectstats).
The scite plugin provides a way to visually inspect the reference list to identify possible references of concern.
...
The COVID-19 Review Consortium provided a platform for researchers to engage in scientific investigation during the initial phase of the COVID-19 pandemic during 2020 at a time when many biological scientists were unable to access their research spaces (Figure @fig:wordcloud).
