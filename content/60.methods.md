...
The manuscript has continued to grow throughout the first year of the project, with both word count and number of references continuing to trend upwards (Figure @projectstats).
Similarly, though only a fraction of potential contributors ended up contributing to the text included in the manuscripts (Figure @projectstats), many of these contributors remained engaged over the course of a full year (Figure with dots).
...
The COVID-19 Review Consortium provided a platform for researchers to engage in scientific investigation during the initial phase of the COVID-19 pandemic during 2020 at a time when many biological scientists were unable to access their research spaces (Figure @wordcloud).
